...
import com.xiangyanlin.redis.redisoperationdemo.model.TestEntity;
import com.xiangyanlin.redis.redisoperationdemo.utils.RedisUtil;
...
public class RedisUtilTest {
    ...
    public void testSetObject() {
        ...
        TestEntity testModel2 = (TestEntity) redisUtil.get("testModel");
...
//        System.in.read();// 加入该代码，让主线程不挂掉
    ...
    public void testHsetObject() {
        ...
        TestEntity testModel2 = (TestEntity) redisUtil.hget("hash", "testModel");
        System.err.println(testModel2);
        System.err.println(testModel2.getName());
        System.err.println(testModel2.getId());
    }
